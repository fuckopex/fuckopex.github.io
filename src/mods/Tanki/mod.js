class Mod {
	...
	type = 'TANKI';
	title = 'Танки Онлайн';
	desc = `Данный мод является стандартным клиентом игры, добавленный для удобства игроков.

С помощью него можно играть в любимую игру не переходя на официальный сайт %)`;
